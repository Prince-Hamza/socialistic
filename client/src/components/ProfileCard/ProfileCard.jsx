    ...
    <div className="ProfileCard">
      ...
      <div className="ProfileImages">
        ...
        <div style={{ position: 'relative' }} >
          ...
          {window.location.href.includes('profile') && <button style={{ position: 'absolute', right: '15px', bottom: '15px' }} className="button ps-button" onClick={() => { onClickEditCover() }} >
        ...
        <div className="ProfileImages" style={{ position: 'relative' }} >
          ...
          {window.location.href.includes('profile') && <button style={{ position: 'absolute', right: '15px', bottom: '15px' }} className="button ps-button" onClick={() => { onClickEditProfile() }}>
      ...
      <div className="ProfileName">
        ...
        <Row style={{ width: '50%' }} >
          {!introEdit && <div style={{ width: window.location.href.includes('profile') ? '70%' : '100%', textAlign: 'center' }} >{appInfo.userInfo.about ? appInfo.userInfo.about : 'Write about yourself'}</div>}
          {introEdit &&
          ...
          {window.location.href.includes('profile') && <button style={{ width: '55px', height: '25px' }} className="button ps-button" onClick={() => { setIntroEdit(true); }}>
            Edit
          </button>}
        </Row>
